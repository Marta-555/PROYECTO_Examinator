window.addEventListener("load", function(){
    ...
    function pedirDatosJson(pagina){
        ...
        fetch("pedirDatosJson.php?tabla=examPredef&pagina="+pagina+"&filas=4", {
            method:"GET"
    ...
    function pintarTabla(objetoAlumno){
        objetoAlumno.forEach(elemento => {
            ...
            var btHacer = document.createElement("span");
            btHacer.innerHTML = "Realizar examen";
            btHacer.style.textDecoration = "underline";
            btHacer.onclick = hacerExamen;

            columna5.appendChild(btHacer);
