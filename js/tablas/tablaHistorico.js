window.addEventListener("load", function(){
    ...
    function pedirDatosJson(pagina){
        ...
        fetch("pedirDatosJson.php?tabla=historico&pagina="+pagina+"&filas=4", {
            method:"GET"
    ...
    function pintarTabla(objetoExam){
        objetoExam.forEach(elemento => {
            ...
            columna1.innerHTML = elemento.email;
            columna2.innerHTML = elemento.fecha;
            columna3.innerHTML = elemento.calificacion;
